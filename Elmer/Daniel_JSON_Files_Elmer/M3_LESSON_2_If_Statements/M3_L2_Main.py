...
class MainWindow(QWidget):
    def __init__(self, lesson_number=3, *args, **kwargs):
        ...
        self.progress_bar = ProgressBar( JsonLoader.load_json_data(
                os.path.join(os.path.dirname(os.path.dirname(
                    os.path.abspath(__file__))), "Page_order", "page_order_M3.json")), 1)
        self.init_ui()
    ...
    def switch_page(self, forward=True):
        ...
        # Sí se alcanza el final del recorrido de páginas, guardar el registro y cerrar la aplicación
            ...
            self.actualizar_progreso_usuario('Modulo3', 'Leccion2')
            self.actualizar_leccion_completada('Modulo3', 'Leccion2')
            ...
            update_lesson_dates(self.usuario_actual, "Modulo3", "Leccion_completada2")           

            if are_lessons_completed_same_day(self.usuario_actual, "Modulo3"):
                    display_badge('modulo_rapido')
                    update_badge_progress(self.usuario_actual, 'modulo_rapido')
            
            if are_two_lessons_completed_same_day(self.usuario_actual, "Modulo3"):
