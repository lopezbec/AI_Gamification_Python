...
class JsonLoader:
    ...
    def load_json_data(filename):
        with open('M3_LESSON_2_If_Statements/' + filename, encoding='UTF-8') as json_file:
...
class MainWindow(QWidget):
    def __init__(self, lesson_number=3, *args, **kwargs):
        ...
        self.progress_bar = ProgressBar(JsonLoader.load_json_data(os.path.join("..", "Page_order", "page_order_M3.json")), 1)
        self.init_ui()
    ...
    def save_log(self, log_type="time"):
        ...
        filepath = os.path.join('M3_LESSON_2_If_Statements', filename)
