...
from PyQt6.QtWidgets import QApplication, QTextEdit, QWidget, QVBoxLayout, QHBoxLayout, QFrame, QLabel, QPushButton, QStackedWidget, QRadioButton, QButtonGroup, QSizePolicy, QCheckBox
...
class MainWindow(QWidget):
    ...
    def save_log(self, log_type="time"):
        ...
        filename = "M3_L2_Time.csv" if log_type == "time" else "M3_L2_Entradas_Salidas_Clics.csv"
        ...
        if not os.path.exists('M3_LESSON_2_If_Statements'):
            os.makedirs('M3_LESSON_2_If_Statements')
