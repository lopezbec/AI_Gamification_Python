...
from PyQt6.QtWidgets import QTextEdit, QWidget, QVBoxLayout, QHBoxLayout, QFrame, QLabel, QPushButton, QStackedWidget, QRadioButton, QButtonGroup, QSizePolicy, QCheckBox
...
class MainWindow(QWidget):
    def __init__(self, lesson_number=3, *args, **kwargs):
        ...
        self.setWindowTitle("Declaraciones if")
    ...
    def switch_page(self, forward=True):
        ...
        # Sí se alcanza el final del recorrido de páginas, guardar el registro y cerrar la aplicación
            ...
            self.save_log(modulo=3, leccion=2)
            ...
            self.actualizar_progreso_usuario('Módulo3', 'Leccion2')
            self.actualizar_leccion_completada('Módulo3', 'Leccion2')
            update_lesson_status(self.usuario_actual, 'Módulo3', 'Leccion2', self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "Módulo3", "Leccion_completada2")           
            if are_lessons_completed_same_day(self.usuario_actual, "Módulo3") and not is_badge_earned(self.usuario_actual, 'modulo_rapido'):
                    display_badge('modulo_rapido')
                    update_badge_progress(self.usuario_actual, 'modulo_rapido')
            if are_two_lessons_completed_same_day(self.usuario_actual, "Módulo3") and not is_badge_earned(self.usuario_actual, 'doble_aprendizaje'):
