...
class MainWindow(QWidget):
    ...
    def switch_page(self, forward=True):
        ...
        # Sí se alcanza el final del recorrido de páginas, guardar el registro y cerrar la aplicación
            ...
            self.save_log(modulo=5, leccion=4)
            ...
            self.actualizar_progreso_usuario('Módulo5', 'Leccion4')
            self.actualizar_leccion_completada('Módulo5', 'Leccion4')
            update_lesson_status(self.usuario_actual, 'Módulo5', 'Leccion4', self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "Módulo5", "Leccion_completada4")           
