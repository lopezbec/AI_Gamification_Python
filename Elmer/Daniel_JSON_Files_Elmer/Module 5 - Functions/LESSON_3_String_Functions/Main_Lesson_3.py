...
class JsonLoader:
    ...
    def load_json_data(filename):
        with open('LESSON_3_String_Functions/' + filename, encoding='UTF-8') as json_file:
...
class MainWindow(QWidget):
    ...
    def save_log(self, log_type="time"):
        ...
        if not os.path.exists('LESSON_3_String_Functions'):
            os.makedirs('LESSON_3_String_Functions')

        # Guardar el archivo en la carpeta especificada
        filepath = os.path.join('LESSON_3_String_Functions', filename)
