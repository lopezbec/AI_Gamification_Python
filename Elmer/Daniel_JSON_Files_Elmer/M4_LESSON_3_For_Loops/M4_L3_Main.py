...
class MainWindow(QWidget):
    ...
    def switch_page(self, forward=True):
        ...
        # Sí se alcanza el final del recorrido de páginas, guardar el registro y cerrar la aplicación
            ...
            self.save_log(modulo=4, leccion=3)
            ...
            self.actualizar_progreso_usuario('Módulo4', 'Leccion3')
            self.actualizar_leccion_completada('Módulo4', 'Leccion3')
            update_lesson_status(self.usuario_actual, 'Módulo4', 'Leccion3', self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "Módulo4", "Leccion_completada3")           
