...
class JsonLoader:
    ...
    def load_json_data(filename):
        with open('M2_LESSON_1_Taking_User_Input/' + filename, encoding='UTF-8') as json_file:
...
class MainWindow(QWidget):
    def __init__(self, lesson_number, *args, **kwargs):
        ...
        self.progress_bar = ProgressBar(
            JsonLoader.load_json_data(os.path.join("..", "Page_order", "page_order_M2.json")), 0)
        self.init_ui()
    ...
    def save_log(self, log_type="time"):
        ...
        filename = "M2_L1_Time.csv" if log_type == "time" else "M2_L1_Entradas_Salidas_Clics.csv"
        ...
        if not os.path.exists('M2_LESSON_1_Taking_User_Input'):
            os.makedirs('M2_LESSON_1_Taking_User_Input')

        # Guardar el archivo en la carpeta especificada
        filepath = os.path.join('M2_LESSON_1_Taking_User_Input', filename)
