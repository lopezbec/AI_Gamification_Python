...
class MainWindow(QWidget):
    def __init__(self, lesson_number, *args, **kwargs):
        ...
        self.setWindowTitle("Aprendiendo Python - Módulo 2, Lección 1")

        self.progress_bar = ProgressBar(JsonLoader.load_json_data(os.path.join("..", "Page_order", "page_order_M2.json")), 0)
        self.init_ui()
