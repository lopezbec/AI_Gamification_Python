...
class MainWindow(QWidget):
    ...
    def switch_page(self, forward=True):
        ...
        # Sí se alcanza el final del recorrido de páginas, guardar el registro y cerrar la aplicación
            ...
            self.actualizar_progreso_usuario('Módulo2', 'Leccion1')
            self.actualizar_leccion_completada('Módulo2', 'Leccion1')
            update_lesson_status(self.usuario_actual, 'Módulo2', 'Leccion1', self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "Módulo2", "Leccion_completada1")
            if are_lessons_completed_same_day(self.usuario_actual, "Módulo2") and not is_badge_earned(self.usuario_actual, 'modulo_rapido'):
                display_badge('modulo_rapido')
                update_badge_progress(self.usuario_actual, 'modulo_rapido')
            if are_two_lessons_completed_same_day(self.usuario_actual, "Módulo2") and not is_badge_earned(self.usuario_actual, 'doble_aprendizaje'):
