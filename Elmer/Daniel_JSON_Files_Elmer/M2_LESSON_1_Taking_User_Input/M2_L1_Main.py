...
class MainWindow(QWidget):
    ...
    def switch_page(self, forward=True):
        ...
        # Si se alcanzó el final de las páginas, guardar el registro y cerrar la aplicación
            ...
            self.actualizar_progreso_usuario("modulo_2", "leccion1")
            self.actualizar_leccion_completada("modulo_2", "leccion1")
            update_lesson_status(self.usuario_actual, "modulo_2", "Leccion_completada1", self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "modulo_2", "Leccion_completada1")
            if are_lessons_completed_same_day(self.usuario_actual, "modulo_2") and not is_badge_earned(
