...
class MainWindow(QWidget):
    def __init__(self, lesson_number=3, *args, **kwargs):
        ...
        self.setWindowTitle("Comentarios y Docstring")
    ...
    def switch_page(self, forward=True):
        ...
        # Sí se alcanza el final del recorrido de páginas, guardar el registro y cerrar la aplicación
            ...
            self.actualizar_progreso_usuario('Módulo5', 'Leccion7')
            self.actualizar_leccion_completada('Módulo5', 'Leccion7')
            update_lesson_status(self.usuario_actual, 'Módulo5', 'Leccion7', self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "Módulo5", "Leccion_completada7")           
