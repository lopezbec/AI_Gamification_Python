...
class MainWindow(QWidget):
    ...
    def actualizar_leccion_completada(self, modulo, leccion_completada):
        try:
            ...
            total_lecciones_modulo = 7  # Por ejemplo, el módulo tiene 5 lecciones
    ...
    def switch_page(self, forward=True):
        ...
        # Si se alcanzó el final de las páginas, guardar el registro y cerrar la aplicación
            ...
            self.actualizar_progreso_usuario("modulo_5", "leccion7")
            self.actualizar_leccion_completada("modulo_5", "leccion7")
            update_lesson_status(self.usuario_actual, "modulo_5", "Leccion_completada7", self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "modulo_5", "Leccion_completada7")
            if are_lessons_completed_same_day(self.usuario_actual, "modulo_5") and not is_badge_earned(
