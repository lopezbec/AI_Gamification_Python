...
class JsonLoader:
    ...
    def load_json_data(filename):
        with open('M5_LESSON_7_Comments_and_Docstrings/' + filename, encoding='UTF-8') as json_file:
...
class MainWindow(QWidget):
    def __init__(self, lesson_number=3, *args, **kwargs):
        ...
        self.setWindowTitle("Aprendiendo Python - Módulo 5, Lección 7")

        self.progress_bar = ProgressBar(JsonLoader.load_json_data(os.path.join("..", "Page_order", "page_order_M5.json")), 6)
        self.init_ui()
    ...
    def save_log(self, log_type="time"):
        ...
        filename = "M5_l7_Time.csv" if log_type == "time" else "M5_l7_Entradas_Salidas_Clics.csv"
        ...
        if not os.path.exists('M5_LESSON_7_Comments_and_Docstrings'):
            os.makedirs('M5_LESSON_7_Comments_and_Docstrings')

        # Guardar el archivo en la carpeta especificada
        filepath = os.path.join('M5_LESSON_7_Comments_and_Docstrings', filename)
