...
class JsonLoader:
    ...
    def load_json_data(filename):
        with open('M3_LESSON_5_while_Loops/' + filename, encoding='UTF-8') as json_file:
...
class MainWindow(QWidget):
    ...
    def save_log(self, log_type="time"):
        ...
        filename = "M3_L5_Time.csv" if log_type == "time" else "M3_L5_Entradas_Salidas_Clics.csv"
        ...
        if not os.path.exists('M3_LESSON_5_while_Loops'):
            os.makedirs('M3_LESSON_5_while_Loops')

        # Guardar el archivo en la carpeta especificada
        filepath = os.path.join('M3_LESSON_5_while_Loops', filename)
