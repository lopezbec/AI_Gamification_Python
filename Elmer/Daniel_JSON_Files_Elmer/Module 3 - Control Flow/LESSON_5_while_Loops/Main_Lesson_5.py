...
class JsonLoader:
    ...
    def load_json_data(filename):
        with open('LESSON_5_while_Loops/' + filename, encoding='UTF-8') as json_file:
...
class MainWindow(QWidget):
    ...
    def save_log(self, log_type="time"):
        ...
        if not os.path.exists('LESSON_5_while_Loops'):
            os.makedirs('LESSON_5_while_Loops')

        # Guardar el archivo en la carpeta especificada
        filepath = os.path.join('LESSON_5_while_Loops', filename)
