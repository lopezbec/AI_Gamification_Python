...
class JsonLoader:
    ...
    def load_json_data(filename):
        try:
            ...
            print(f"Error load_json_data en la línea {sys.exc_info()[2].tb_lineno}: {e}")
    ...
    def load_active_widgets():
        try:
            ...
            print(f"Error al cargar widgets activos: {e}")
            return {}
...
class MainWindow(QWidget):
    ...
    def switch_page(self, forward=True):
        ...
        # Sí se alcanza el final del recorrido de páginas, guardar el registro y cerrar la aplicación
            ...
            self.save_log(modulo=1, leccion=4)
            ...
            update_lesson_status(self.usuario_actual, 'Modulo1', 'Leccion4', self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "Modulo1", "Leccion_completada4")         
