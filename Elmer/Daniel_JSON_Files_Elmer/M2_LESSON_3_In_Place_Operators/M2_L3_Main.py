...
class JsonLoader:
    ...
    def load_json_data(filename):
        with open('M2_LESSON_3_In_Place_Operators/' + filename, encoding='UTF-8') as json_file:
...
class MainWindow(QWidget):
    def __init__(self, lesson_number=3, *args, **kwargs):
        ...
        self.progress_bar = ProgressBar(JsonLoader.load_json_data(os.path.join("..", "Page_order", "page_order_M2.json")), 2)
        self.init_ui()
    ...
    def save_log(self, log_type="time"):
        ...
        filename = "M2_L3_Time.csv" if log_type == "time" else "M2_L3_Entradas_Salidas_Clics.csv"
        ...
        if not os.path.exists('M2_LESSON_3_In_Place_Operators'):
            os.makedirs('M2_LESSON_3_In_Place_Operators')

        # Guardar el archivo en la carpeta especificada
        filepath = os.path.join('M2_LESSON_3_In_Place_Operators', filename)
