...
class MainWindow(QWidget):
    ...
    def switch_page(self, forward=True):
        ...
        # Sí se alcanza el final del recorrido de páginas, guardar el registro y cerrar la aplicación
            ...
            self.actualizar_leccion_completada('Modulo2', 'Leccion3')
            update_lesson_status(self.usuario_actual, 'Modulo2', 'Leccion3', self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "Modulo2", "Leccion_completada3")           
