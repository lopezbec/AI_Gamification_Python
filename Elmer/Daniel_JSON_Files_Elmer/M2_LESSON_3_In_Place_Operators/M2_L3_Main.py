...
class MainWindow(QWidget):
    ...
    def actualizar_leccion_completada(self, modulo, leccion_completada):
        try:
            ...
            total_lecciones_modulo = 3  # Por ejemplo, el módulo tiene 5 lecciones
    ...
    def switch_page(self, forward=True):
        ...
        # Si se alcanzó el final de las páginas, guardar el registro y cerrar la aplicación
            ...
            self.actualizar_progreso_usuario("modulo_2", "leccion3")
            self.actualizar_leccion_completada("modulo_2", "leccion3")
            update_lesson_status(self.usuario_actual, "modulo_2", "Leccion_completada3", self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "modulo_2", "Leccion_completada3")
