...
from PyQt6.QtWidgets import QApplication, QTextEdit, QWidget, QFrame, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, \
...
class MainWindow(QWidget):
    def __init__(self, lesson_number=3, *args, **kwargs):
        ...
        self.progress_bar = ProgressBar(
            JsonLoader.load_json_data(os.path.join("..", "Page_order", "page_order_M3.json")), 4)
        self.init_ui()
