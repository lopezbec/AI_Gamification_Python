...
from PyQt6.QtWidgets import QTextEdit, QWidget, QFrame, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, \
...
class MainWindow(QWidget):
    ...
    def switch_page(self, forward=True):
        ...
        id_modulo = "modulo_3"  # Usa el número de lección para identificar el módulo
