...
class JsonLoader:
    ...
    def load_json_data(filename):
        with open('M1_LESSON_5_Labeling_Storing_and_Handling_Data_with_Variables/' + filename, encoding='UTF-8') as json_file:
...
class MainWindow(QWidget):
    def __init__(self, lesson_number=3, *args, **kwargs):
        ...
        self.setWindowTitle("Aprendiendo Python - Módulo 1, Lección 5")
    ...
    def save_log(self, log_type="time"):
        ...
        filename = "M1_L5_Time.csv" if log_type == "time" else "M1_L5_Entradas_Salidas_Clics.csv"
        ...
        if not os.path.exists('M1_LESSON_5_Labeling_Storing_and_Handling_Data_with_Variables'):
