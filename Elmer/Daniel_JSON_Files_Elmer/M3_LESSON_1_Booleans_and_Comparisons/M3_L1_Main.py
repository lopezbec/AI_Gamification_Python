...
class MainWindow(QWidget):
    ...
    def switch_page(self, forward=True):
        ...
        # Sí se alcanza el final del recorrido de páginas, guardar el registro y cerrar la aplicación
            ...
            self.actualizar_progreso_usuario('Módulo3', 'Leccion1')
            self.actualizar_leccion_completada('Módulo3', 'Leccion1')
            update_lesson_status(self.usuario_actual, 'Módulo3', 'Leccion1', self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "Módulo3", "Leccion_completada1")           
