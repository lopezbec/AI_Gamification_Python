...
from PyQt6.QtWidgets import QScrollArea, QWidget, QTextEdit, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QStackedWidget, QRadioButton, QButtonGroup, QCheckBox, QFrame
...
class MainWindow(QWidget):
    def __init__(self, lesson_number=3, *args, **kwargs):
        ...
        self.setWindowTitle("Segmentos de lista")
    ...
    def load_page_order(self):
        ...
        file_path = os.path.join('Page_order', 'page_order_M4.json')
        ...
        raise ValueError(f"Lesson {self.lesson_number} not found in page_order_M4.json")
    ...
    def switch_page(self, forward=True):
        ...
        id_modulo = "modulo_4"  # Usa el número de lección para identificar el módulo
...
def M4_L5_Main():
    main_window = MainWindow(lesson_number=5)
    main_window.show()
    return main_window
