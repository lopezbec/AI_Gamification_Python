...
class MainWindow(QWidget):
    ...
    def switch_page(self, forward=True):
        ...
        # Sí se alcanza el final del recorrido de páginas, guardar el registro y cerrar la aplicación
            ...
            self.actualizar_progreso_usuario('Módulo4', 'Leccion5')
            self.actualizar_leccion_completada('Módulo4', 'Leccion5')
            update_lesson_status(self.usuario_actual, 'Módulo4', 'Leccion5', self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "Módulo4", "Leccion_completada5")           
            if are_lessons_completed_same_day(self.usuario_actual, "Módulo4") and not is_badge_earned(self.usuario_actual, 'modulo_rapido'):
