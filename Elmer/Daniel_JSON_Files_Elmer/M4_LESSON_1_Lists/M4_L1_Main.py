...
from PyQt6.QtWidgets import QApplication, QWidget, QTextEdit, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QStackedWidget, QRadioButton, QButtonGroup, QSizePolicy, QCheckBox, QFrame
...
class JsonLoader:
    ...
    def load_json_data(filename):
        with open('M4_LESSON_1_Lists/' + filename, encoding='UTF-8') as json_file:
...
class MainWindow(QWidget):
    ...
    def save_log(self, log_type="time"):
        ...
        filename = "M4_L1_Time.csv" if log_type == "time" else "M4_L1_Entradas_Salidas_Clics.csv"
        ...
        if not os.path.exists('M4_LESSON_1_Lists'):
            os.makedirs('M4_LESSON_1_Lists')

        # Guardar el archivo en la carpeta especificada
        filepath = os.path.join('M4_LESSON_1_Lists', filename)
