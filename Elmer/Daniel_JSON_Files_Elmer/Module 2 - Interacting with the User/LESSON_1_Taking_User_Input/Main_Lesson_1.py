...
class JsonLoader:
    ...
    def load_json_data(filename):
        with open('LESSON_1_Taking_User_Input/' + filename, encoding='UTF-8') as json_file:
...
class MainWindow(QWidget):
    ...
    def save_log(self, log_type="time"):
        ...
        if not os.path.exists('LESSON_1_Taking_User_Input'):
            os.makedirs('LESSON_1_Taking_User_Input')

        # Guardar el archivo en la carpeta especificada
        filepath = os.path.join('LESSON_1_Taking_User_Input', filename)
