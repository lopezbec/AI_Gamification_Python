...
class MainWindow(QWidget):
    def __init__(self, lesson_number=3, *args, **kwargs):
        ...
        self.setWindowTitle("Argumentos de las funciones")
    ...
    def switch_page(self, forward=True):
        ...
        # Sí se alcanza el final del recorrido de páginas, guardar el registro y cerrar la aplicación
            ...
            self.save_log(modulo=5, leccion=5)
            ...
            self.actualizar_progreso_usuario('Módulo5', 'Leccion5')
            self.actualizar_leccion_completada('Módulo5', 'Leccion5')
            update_lesson_status(self.usuario_actual, 'Módulo5', 'Leccion5', self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "Módulo5", "Leccion_completada5")           
            if are_lessons_completed_same_day(self.usuario_actual, "Módulo5") and not is_badge_earned(self.usuario_actual, 'modulo_rapido'):
                    display_badge('modulo_rapido')
                    update_badge_progress(self.usuario_actual, 'modulo_rapido')
            if are_two_lessons_completed_same_day(self.usuario_actual, "Módulo5") and not is_badge_earned(self.usuario_actual, 'doble_aprendizaje'):
