...
class MainWindow(QWidget):
    ...
    def switch_page(self, forward=True):
        ...
        # Sí se alcanza el final del recorrido de páginas, guardar el registro y cerrar la aplicación
            ...
            self.actualizar_progreso_usuario('Módulo2', 'Leccion2')
            self.actualizar_leccion_completada('Módulo2', 'Leccion2')
            update_lesson_status(self.usuario_actual, 'Módulo2', 'Leccion2', self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "Módulo2", "Leccion_completada2")           
