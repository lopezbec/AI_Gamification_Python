...
class MainWindow(QWidget):
    ...
    def switch_page(self, forward=True):
        ...
        # Si se alcanzó el final de las páginas, guardar el registro y cerrar la aplicación
            ...
            self.actualizar_progreso_usuario("modulo_4", "leccion4")
            self.actualizar_leccion_completada("modulo_4", "leccion4")
            update_lesson_status(self.usuario_actual, "modulo_4", "Leccion_completada4", self.all_correct)
            ...
            update_lesson_dates(self.usuario_actual, "modulo_4", "Leccion_completada4")
